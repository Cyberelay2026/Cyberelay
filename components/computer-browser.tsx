      ...
      <div className="container">
        ...
        <div className="filters">
          ...
          <label>
            ...
            <select value={ram} onChange={(e) => setRam(e.target.value)}>
              <option>All</option>
              {ramOptions.map((value) => <option value={value} key={value}>{value}GB</option>)}
            </select>
          </label>
          ...
          <label>
            ...
            <select value={storage} onChange={(e) => setStorage(e.target.value)}>
              <option>All</option>
              {storageOptions.map((value) => <option value={value} key={value}>{value >= 1024 ? `${value / 1024}TB` : `${value}GB`}</option>)}
            </select>
          </label>
        ...
        {loadError ? (
          <div className="empty-state">
            <h2>Inventory temporarily unavailable</h2>
